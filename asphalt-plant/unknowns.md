...
_26 item(s) need data or verification._
...
| breaker | MDP-1 | pos 17 () | poles, frame, model, conductor, load_served | ASSUMED | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos 19 () | poles, trip_amps, frame, model, conductor, load_served | ASSUMED | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos 21 (EPR-1 (P11)) | poles, frame, model, conductor | ASSUMED | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos 2 () | poles, frame, model, conductor, load_served | ASSUMED | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos 4 (RACK 2 PUMP (P4)) | conductor | TBD | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos 6 () | poles, trip_amps, frame, model, conductor, load_served | ASSUMED | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos 8 () | poles, trip_amps, frame, model, conductor, load_served | ASSUMED | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos 10 () | poles, trip_amps, frame, model, conductor, load_served | ASSUMED | panels/MDP-1/panel.yaml |
...
| breaker | MDP-1 | pos TBD-MILL-AIR-COMP (MILL #2 AIR COMPRESSOR (M11)) | poles, trip_amps, frame, model, conductor | ASSUMED | panels/MDP-1/panel.yaml |
| breaker | MDP-1 | pos TBD-EMULSIFIER-P6 (EMULSIFIER PUMP (P6)) | poles, trip_amps, frame, model, conductor | ASSUMED | panels/MDP-1/panel.yaml |
